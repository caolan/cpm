...
exports.readJSON = function (path, callback) {
    fs.readFile(path, function (err, content) {
        try {
            callback(err, err ? null: JSON.parse(content.toString()));
        }
        catch (e) {
...
/**
 * Load package metadata, from either a url, repository or on the filesystem.
 *
...
exports.getMetadata = function (settings, loc, callback) {
    switch (exports.locationType(loc)) {
        case 'url':
            ...
            break;
        case 'file':
            exports.readJSON(path.join(loc, 'package.json'), callback);
            break;
        case 'repository':
            var split = loc.split('@');
            var pkg = split[0];
